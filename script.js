...
window.addEventListener('load', () => {
    ...
    // Initialize skill bars for visible sections
...
console.log('%cBạn đang xem portfolio của một Software Architect!', 'font-size: 14px; color: #4a5568;');
console.log('%cNếu bạn quan tâm đến code, hãy liên hệ với tôi! 🚀', 'font-size: 14px; color: #667eea;');
